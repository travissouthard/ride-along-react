    ...
    return (
        <main>
            ...
            <article>
                ...
                {props.video ? (
                <iframe src={"https://www.youtube.com/embed/" + props.video["url"]} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
